    ...
    <div class="container-fluid">
        ...
        <div class="grid 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-10">
            <div class="rounded-xl bg-rose-100 min-h-96 flex justify-center items-center">
                <button class="bg-[#FF0000] text-white hover:bg-red-600 hover:text-gray-200 rounded-full" data-te-toggle="modal" data-te-target="#create_project_modal" onclick="select_mode('Sketch')">
